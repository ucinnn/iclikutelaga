...
<header class="fi-simple-header flex flex-col items-center">
   <!--[if BLOCK]><![endif]--><?php if($logo): ?>
        <div class="fi-simple-header-logo flex justify-center">
            <!--[if BLOCK]><![endif]--><?php if($logoUrl ?? url('/')): ?>
                <a href="<?php echo e($logoUrl ?? url('/')); ?>" class="transition-opacity hover:opacity-80">
...
<?php /**PATH C:\laragon\www\TA\Information Center FInal\resources\views/vendor/filament-panels/components/header/simple.blade.php ENDPATH**/ ?>