...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament::components.dropdown.index','data' => ['placement' => 'bottom-start','maxHeight' => '36rem']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['placement' => 'bottom-start','maxHeight' => '36rem']); ?>
     <?php $__env->slot('trigger', null, ['style' => 'justify-self: center; align-self: center; padding: 5px 0;']); ?> 
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament::components.link','data' => ['tag' => 'button']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['tag' => 'button']); ?>
                <div style="width: 2rem; height: 2rem; border-radius: 9999px; overflow: hidden;">
                    <?php echo e(svg('flag-1x1-'.$currentLanguage['flag'], '')); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament::components.icon-button','data' => ['icon' => 'heroicon-o-language','label' => 'Language switcher']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['icon' => 'heroicon-o-language','label' => 'Language switcher']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament::components.dropdown.list.index','data' => ['style' => 'max-height: 20rem; overflow-y: auto;']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['style' => 'max-height: 20rem; overflow-y: auto;']); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament::components.dropdown.list.item','data' => ['href' => route('filament-language-switcher.switch', ['code' => $language['code']]),'tag' => 'a']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('filament-language-switcher.switch', ['code' => $language['code']])),'tag' => 'a']); ?>
                <span class="fi-dropdown-list-item-label" style="text-overflow: ellipsis; overflow: hidden; white-space: nowrap; width: 100%; text-align: left; display: flex; justify-content: flex-start; gap: 0.75rem;">
                    <?php if($showFlags): ?>
                        <div style="width: 1.5rem; height: 1.5rem; flex-shrink: 0;">
                            <?php echo e(svg('flag-4x3-'.$language['flag'], '')); ?>

                        </div>
                        <span><?php echo e($language['name']); ?></span>
                    <?php else: ?>
                        <span style="<?php echo e($isCurrent ? 'font-weight: 600;' : ''); ?>">
                            <?php echo e(str($language['code'])->upper()->value() . " - {$language['name']}"); ?>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\TA\Information Center FInal\resources\views/vendor/filament-language-switcher/language-switcher.blade.php ENDPATH**/ ?>