    ...
    <head>
        ...
        <style>
            :root {
                ...
                .fi-sidebar {
                    border-right: 3px solid rgba(100, 116, 139, 0.2); /* slate-400/20 */
                }

                .dark .fi-sidebar {
                    border-right-color: rgba(255, 255, 255, 0.1); /* lebih halus di dark mode */
                }
                .fi-sidebar[data-state="collapsed"] .brand-text {
                    display: none !important;
                }

                .fi-sidebar[data-state="collapsed"] .brand-logo {
                    margin: auto;
                }
            }
        </style>
...
$__html = app('livewire')->mount($__name, $__params, 'lw-2072206174-0', $__slots ?? [], get_defined_vars());
...
<?php /**PATH C:\laragon\www\TA\Information Center FInal\resources\views/vendor/filament-panels/components/layout/base.blade.php ENDPATH**/ ?>