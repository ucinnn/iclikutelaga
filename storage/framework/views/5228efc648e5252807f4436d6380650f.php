...
<?php endif; ?>
            ...
            <div class="flex-1">
                <h2 class="grid flex-1 text-base font-semibold leading-6 text-gray-950 dark:text-white">
                    <?php echo e(__('dashboard.welcome', [
                        'app' => filament()->getCurrentPanel()->getBrandName(), config('app.name')
                    ])); ?>
            ...
            <div class="flex items-center gap-4">
                <a href="<?php echo e(filament()->getProfileUrl()); ?>">
                    <?php if (isset($component)) { $__componentOriginal6330f08526bbb3ce2a0da37da512a11f = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal6330f08526bbb3ce2a0da37da512a11f = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament::components.button.index','data' => ['icon' => 'heroicon-m-pencil-square','color' => 'primary','size' => 'sm','labeledFrom' => 'sm']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['icon' => 'heroicon-m-pencil-square','color' => 'primary','size' => 'sm','labeled-from' => 'sm']); ?>
                        <?php echo e(__('dashboard.edit_profile')); ?>
...
<?php endif; ?>
                ...
                <form action="<?php echo e(filament()->getLogoutUrl()); ?>" method="post" class="my-auto">
                    ...
                    <?php if (isset($component)) { $__componentOriginal6330f08526bbb3ce2a0da37da512a11f = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal6330f08526bbb3ce2a0da37da512a11f = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament::components.button.index','data' => ['color' => 'gray','icon' => 'heroicon-m-arrow-left-on-rectangle','iconAlias' => 'panels::widgets.account.logout-button','size' => 'sm','labeledFrom' => 'sm','tag' => 'button','type' => 'submit']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('filament::button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['color' => 'gray','icon' => 'heroicon-m-arrow-left-on-rectangle','icon-alias' => 'panels::widgets.account.logout-button','size' => 'sm','labeled-from' => 'sm','tag' => 'button','type' => 'submit']); ?>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\TA\Information Center FInal\resources\views/filament/widgets/account-widget.blade.php ENDPATH**/ ?>