...
<?php $component->withAttributes([]); ?>
         <?php $__env->slot('heading', null, []); ?> 
            <div class="flex items-center gap-2">
                ...
                <span><?php echo e(__('faq-widget.heading')); ?></span>
            </div>
         <?php $__env->endSlot(); ?>
...
<?php $component->withAttributes(['color' => 'primary']); ?>
                    <?php echo e(__('faq-widget.questions_badge', ['count' => $totalFaqs])); ?>
...
<?php $component->withAttributes(['color' => 'success']); ?>
                    <?php echo e(__('faq-widget.categories_badge', ['count' => $totalCategories])); ?>
        ...
        <div class="mb-6 grid grid-cols-1 gap-4 md:grid-cols-3">
            ...
            <div class="group relative overflow-hidden rounded-xl bg-gradient-to-br from-primary-50 to-primary-100 p-6 transition-all hover:shadow-lg dark:from-primary-900/20 dark:to-primary-800/20">
                <div class="relative z-10">
                    <p class="text-xs font-medium uppercase tracking-wide text-primary-700 dark:text-primary-300 mb-3"><?php echo e(__('faq-widget.stats.total_faqs')); ?></p>

                    <div class="flex items-center justify-between gap-4">
                        <div class="flex-1">
                            <p class="text-4xl font-bold text-primary-900 dark:text-primary-100"><?php echo e(number_format($totalFaqs)); ?></p>
                            <p class="mt-2 text-xs text-primary-600 dark:text-primary-400"><?php echo e(__('faq-widget.stats.all_questions')); ?></p>
                        </div>
            ...
            <div class="group relative overflow-hidden rounded-xl bg-gradient-to-br from-success-50 to-success-100 p-6 transition-all hover:shadow-lg dark:from-success-900/20 dark:to-success-800/20">
                <div class="relative z-10">
                    <p class="text-xs font-medium uppercase tracking-wide text-success-700 dark:text-success-300 mb-3"><?php echo e(__('faq-widget.stats.categories_title')); ?></p>

                    <div class="flex items-center justify-between gap-4">
                        <div class="flex-1">
                            <p class="text-4xl font-bold text-success-900 dark:text-success-100"><?php echo e(number_format($totalCategories)); ?></p>
                            <p class="mt-2 text-xs text-success-600 dark:text-success-400"><?php echo e(__('faq-widget.stats.topics_covered')); ?></p>
                        </div>
            ...
            <!--[if BLOCK]><![endif]--><?php if($topCategory): ?>
                <div class="group relative overflow-hidden rounded-xl bg-gradient-to-br from-warning-50 to-warning-100 p-6 transition-all hover:shadow-lg dark:from-warning-900/20 dark:to-warning-800/20">
                    <div class="relative z-10">
                        <p class="text-xs font-medium uppercase tracking-wide text-warning-700 dark:text-warning-300 mb-3"><?php echo e(__('faq-widget.stats.most_popular')); ?></p>

                        <div class="flex items-center justify-between gap-4">
                            <div class="flex-1 min-w-0">
                                <p class="text-2xl font-bold text-warning-900 dark:text-warning-100 truncate"><?php echo e($topCategory->category); ?></p>
                                <p class="mt-2 text-xs text-warning-600 dark:text-warning-400"><?php echo e(__('faq-widget.stats.questions_unit', ['count' => $topCategory->count])); ?></p>
                            </div>
            ...
            <?php else: ?>
                <div class="group relative overflow-hidden rounded-xl bg-gradient-to-br from-gray-50 to-gray-100 p-6 transition-all hover:shadow-lg dark:from-gray-900/20 dark:to-gray-800/20">
                    <div class="relative z-10">
                        <p class="text-xs font-medium uppercase tracking-wide text-gray-700 dark:text-gray-300 mb-3"><?php echo e(__('faq-widget.stats.most_popular')); ?></p>

                        <div class="flex items-center justify-between gap-4">
                            <div class="flex-1">
                                <p class="text-2xl font-bold text-gray-900 dark:text-gray-100"><?php echo e(__('faq-widget.stats.no_data')); ?></p>
                                <p class="mt-2 text-xs text-gray-600 dark:text-gray-400"><?php echo e(__('faq-widget.stats.no_categories')); ?></p>
                            </div>
        ...
        <div class="grid grid-cols-1 gap-6 lg:grid-cols-3">
            ...
            <div class="lg:col-span-2">
                <h3 class="mb-4 flex items-center gap-2 text-base font-semibold text-gray-900 dark:text-white">
                    ...
                    <span><?php echo e(__('faq-widget.recent_faqs.heading')); ?></span>
                </h3>

                <div class="space-y-3 max-h-[600px] overflow-y-auto pr-2">
                    <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $recentFaqs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $faq): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="group rounded-xl border border-gray-200 bg-white p-5 transition-all hover:border-primary-300 hover:shadow-md dark:border-gray-700 dark:bg-gray-800/50 dark:hover:border-primary-600">
                            ...
                            <div class="mb-3 flex items-start justify-between gap-3">
                                <div class="flex items-center gap-2 min-w-0 flex-1">
                                    ...
                                    <?php if (isset($component)) { $__componentOriginal986dce9114ddce94a270ab00ce6c273d = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal986dce9114ddce94a270ab00ce6c273d = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament::components.badge','data' => ['color' => 'primary','size' => 'sm']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('filament::badge'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
...
<?php endif; ?>
                                ...
                                <span class="flex-shrink-0 text-xs text-gray-500 dark:text-gray-400">
                                    <?php echo e($faq->created_at->diffForHumans()); ?>
                            ...
                            <div class="flex items-center justify-between border-t border-gray-100 pt-3 dark:border-gray-700">
                                <div class="flex items-center gap-3 text-xs text-gray-600 dark:text-gray-400">
                                    ...
                                    <div class="flex items-center gap-1.5">
                                        ...
                                        <span class="font-medium"><?php echo e($faq->created_by); ?></span>
                                    </div>

                                    
                                    <!--[if BLOCK]><![endif]--><?php if($faq->updated_by && $faq->updated_at != $faq->created_at): ?>
                                        <div class="flex items-center gap-1.5 text-success-600 dark:text-success-400">
                                            <svg class="h-3.5 w-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15" />
                                            </svg>
                                            <span><?php echo e(__('faq-widget.recent_faqs.updated')); ?></span>
                                        </div>
                                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                </div>
                                ...
                                <button class="flex items-center gap-1 text-xs font-medium text-primary-600 transition-colors hover:text-primary-700 dark:text-primary-400 dark:hover:text-primary-300">
                                    <span><?php echo e(__('faq-widget.recent_faqs.read_more')); ?></span>
                    ...
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        <div class="flex flex-col items-center justify-center rounded-xl border-2 border-dashed border-gray-200 py-16 text-center dark:border-gray-700">
                            ...
                            <h3 class="mb-1 text-base font-semibold text-gray-900 dark:text-white">
                                <?php echo e(__('faq-widget.recent_faqs.empty_heading')); ?>

                            </h3>
                            <p class="text-sm text-gray-500 dark:text-gray-400">
                                <?php echo e(__('faq-widget.recent_faqs.empty_description')); ?>
            ...
            <div class="lg:col-span-1">
                <!--[if BLOCK]><![endif]--><?php if($categoryCounts->isNotEmpty()): ?>
                    <div class="rounded-xl bg-white p-6 shadow-sm ring-1 ring-gray-950/5 dark:bg-gray-900 dark:ring-white/10">
                        <h3 class="mb-4 flex items-center gap-2 text-base font-semibold text-gray-900 dark:text-white">
                            <svg class="h-5 w-5 text-primary-600 dark:text-primary-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
                            </svg>
                            <span><?php echo e(__('faq-widget.chart.heading')); ?></span>
                        </h3>
                        ...
                        <div class="space-y-2 border-t border-gray-200 pt-4 dark:border-gray-700">
                            <h4 class="mb-3 text-xs font-semibold uppercase tracking-wide text-gray-500 dark:text-gray-400">
                                <?php echo e(__('faq-widget.chart.all_categories')); ?>

                            </h4>
                            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $categoryCounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php endif; ?>
                        ...
                        <div class="mt-4 space-y-2 border-t border-gray-200 pt-4 dark:border-gray-700">
                            <div class="flex items-center justify-between text-sm">
                                <span class="text-gray-600 dark:text-gray-400"><?php echo e(__('faq-widget.chart.avg_per_category')); ?></span>
                                <span class="font-semibold text-gray-900 dark:text-white">
                                    <?php echo e(round($totalFaqs / max($totalCategories, 1), 1)); ?>

                                </span>
                            </div>
                            <div class="flex items-center justify-between text-sm">
                                <span class="text-gray-600 dark:text-gray-400"><?php echo e(__('faq-widget.chart.largest_category')); ?></span>
                                <span class="font-semibold text-gray-900 dark:text-white">
                                    <?php echo e(__('faq-widget.chart.faqs_unit', ['count' => $topCategory ? $topCategory->count : 0])); ?>
    ...
    <?php $__env->startPush('scripts'); ?>
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                ...
                if (ctx) {
                    const categories = <?php echo json_encode($categoryCounts->pluck('category'), 15, 512) ?>;
                    const counts = <?php echo json_encode($categoryCounts->pluck('count'), 15, 512) ?>;
...
<?php endif; ?><?php /**PATH C:\laragon\www\TA\Information Center FInal\resources\views/filament/widgets/faq-stat-widget.blade.php ENDPATH**/ ?>