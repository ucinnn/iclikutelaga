...
<body class="min-h-screen relative">
    ...
    <div class="relative flex flex-col items-center justify-center min-h-screen px-4 py-12">
        <div class="text-center max-w-6xl w-full space-y-12 animate-slide-up">
            ...
            <!-- Logo & Title -->
            <div class="space-y-6">
                <a href="<?php echo e(route('landingpage')); ?>" class="inline-flex items-center justify-center mb-8 transition-all duration-300 hover:scale-105">
                    <?php if(config('app.logo')): ?>
                        ...
                        <span class="text-4xl font-black text-gray-900"><?php echo e(filament()->getCurrentPanel()->getBrandName() ?? config('app.name')); ?></span>
                    <?php else: ?>
                        <span class="text-4xl font-black text-gray-900"><?php echo e(filament()->getCurrentPanel()->getBrandName() ?? config('app.name')); ?></span>
                    <?php endif; ?>
                </a>
...
<?php /**PATH C:\laragon\www\TA\Information Center FInal\resources\views/loginpage.blade.php ENDPATH**/ ?>