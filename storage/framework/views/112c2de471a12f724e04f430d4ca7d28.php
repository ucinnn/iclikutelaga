...
<?php endif; ?>
            ...
            x-data
            x-bind:class="{
                'max-w-full': !$store.sidebar.isOpen,
                '<?php echo e(match ($maxContentWidth ??= (filament()->getMaxContentWidth() ?? MaxWidth::SevenExtraLarge)) {
            ...
            class="fi-main mx-auto h-full w-full px-4 md:px-6 lg:px-8 transition-all duration-300"
        >
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\TA\Information Center FInal\resources\views/vendor/filament-panels/components/layout/index.blade.php ENDPATH**/ ?>