        ...
        <div class="text-center max-w-2xl w-full space-y-4 animate-slide-up">
            ...
            <a href="<?php echo e(url('/')); ?>"
                ...
                <?php if(config('app.logo')): ?>
                    <img src="<?php echo e(config('app.logo')); ?>" alt="<?php echo e(config('app.name')); ?> Logo" class="h-14 w-auto mr-2 drop-shadow-lg">
                    <span class="text-2xl font-black text-gray-900 dark:text-white">
                        <?php echo e(config('app.name', 'One LTG')); ?>
            ...
            <h2 class="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mb-3 tracking-tight">
                <span class="lang-content" data-lang="en"><?php echo $__env->yieldContent('title'); ?></span>
                <span class="lang-content hidden" data-lang="id">
                    <?php switch(trim(View::yieldContent('code'))):
                        case ('401'): ?>
                            Tidak Terotorisasi
                            <?php break; ?>
                        <?php case ('403'): ?>
            ...
            <div class="text-lg text-gray-600 dark:text-gray-300 mb-6 max-w-lg mx-auto leading-relaxed">
                ...
                <?php if(config('app.debug') && isset($exception) && $exception->getMessage()): ?>
                    <div class="glass-effect rounded-xl p-4 text-left text-xs font-mono overflow-x-auto shadow-xl">
                        ...
                        <code class="text-red-600 dark:text-red-400 break-all"><?php echo e($exception->getMessage()); ?></code>
                    </div>
                <?php else: ?>
                    <p class="lang-content" data-lang="en">
                        <?php switch(trim(View::yieldContent('code'))):
                            case ('401'): ?>
                                <?php echo $__env->yieldContent('message', 'You are not authorized to access this page.'); ?>
                                <?php break; ?>
                            <?php case ('403'): ?>
...
</html><?php /**PATH C:\laragon\www\TA\Information Center FInal\resources\views/errors/layout.blade.php ENDPATH**/ ?>